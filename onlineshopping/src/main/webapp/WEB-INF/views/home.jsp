	...
	<div class="row" ng-init="pCtrl.fetchProducts()">
		...
		<div class="col-md-9">
			...
			<div class="row carousel-holder">
				...
				<div class="row">
                	<div class="col-xs-12">
                		<h3>Nos plats les plus consultés</h3>
                		<hr/>
                	</div>
                </div>
                ...
                <div class="row is-table-row">
                    ...
                    <div class="col-sm-4" ng-repeat="product in pCtrl.mvProducts">                    	
                        <div class="thumbnail">
                            ...
                            <hr/>
                            <div class="caption">
                                <h4 class="pull-right"> {{product.unitPrice}} DH </h4>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <h4>Commander plus de plats!</h4>
                        <hr/>
                        <a class="btn btn-primary" href="${contextRoot}/show/all/products">More Plats</a>
                    </div>
				...
				<div class="row">
                	<div class="col-xs-12">
                		<h3>Nos plats les plus achetés</h3>
                		<hr/>
                	</div>
                </div>
               <div class="row is-table-row">
