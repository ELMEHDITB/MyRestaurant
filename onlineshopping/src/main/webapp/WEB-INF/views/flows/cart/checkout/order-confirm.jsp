	...
	<div class="content">
		<div class="container">
			<div class="alert alert-success">
				<h3 class="text-center">Ton Ordre est Confirme!!</h3>
			</div>
		    <div class="row">
		        <div class="col-xs-12">
		    		...
		    		<div class="row">
		    			<div class="col-xs-6">
		    				<address>
		    					<strong>Paiment Methode:</strong><br>
		    					Carte Paiment <br>
		    						...
		    						<tbody>
		    							...
		    							<c:forEach items="${orderDetail.orderItems}" var="orderItem">
			    							<tr>
			    								...
			    								<td class="text-center"> ${orderItem.buyingPrice} DH</td>
			    								<td class="text-center">${orderItem.productCount}</td>
			    								<td class="text-right"> ${orderItem.total} DH</td>
			    							</tr>
		    							</c:forEach>
		    						</tbody>
		    					</table>
		    ...
		    <div class="text-center">
		    	<a href="${contextRoot}/show/all/products" class="btn btn-lg btn-warning">Continue </a>
		    </div>
		</div>
