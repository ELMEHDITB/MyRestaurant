...
<div class="container">
	...
	<div class="row">
			...
			<div class="col-md-4">
				...
				<h4>Selectionner l'adresse de livraison</h4>
				<hr/>
					...
					<div class="panel-body">
						...
						>
							...
							<div class="form-group">
								<label class="control-label col-md-4" for="addressLineOne">ligne adresse 1 </label>
								<div class="col-md-8">
							...
							<div class="form-group">
								<label class="control-label col-md-4" for="addressLineTwo">Ligne adresse 2</label>
								<div class="col-md-8">
